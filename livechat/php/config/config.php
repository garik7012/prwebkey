...
$config = Utils::arrayMergeRecursive(array(
    ...
    */
    ...
    'chatHeader'             => 'Сообщение нам',
    'startInfo'              => 'Пожалуйста, заполните следующую форму, чтобы начать чат',
    'askForMail'             => 'true',
    'headerHeight'           =>  55,
    'widgetWidth'            => 370,
    'widgetHeight'           => 411,
    ...
    'startLabel'             => 'Старт',
    'backLabel'              => 'Назад',
    'initMessageBody'        => 'Добрый день, чем я могу вам помочь?',
    ...
    'timeMinutesAgo'         => 'minute(s) ago',
    'timeSecondsAgo'         => 'second(s) ago',
    'offlineMessage'         => 'Оператор вышел',
    'toggleSoundLabel'       => 'Звуковые эффекты',
    'toggleScrollLabel'      => 'Auto-scroll',
    'toggleEmoticonsLabel'   => 'Смайлы',
    'toggleAutoShowLabel'    => 'Автопоказ',
    'toggleFullscreenLabel'  => 'Переключить на полный экран',
    'endChatLabel'           => 'Завершить чат',
    'endChatConfirmQuestion' => 'Вы уверены?',
    'endChatConfirm'         => 'Да',
    'endChatCancel'          => 'Отмена',
    'contactHeader'          => 'Связаться с нами',
    'contactInfo'            => 'Все операторы оффлайн. Используйте форму ниже чтобы отправить нам e-mail с вашим вопросом.',
    'contactNameLabel'       => 'Ваше имя',
    'contactMailLabel'       => 'Ваш E-mail',
    'contactQuestionLabel'   => 'Ваш вопрос',
    'contactSendLabel'       => 'Отправить',
    'contactSuccessHeader'   => 'Сообщение отправлено',
    'contactSuccessMessage'  => 'Ваш вопрос был отправлен.',
    'contactErrorHeader'     => 'Ошибка',
    'contactErrorMessage'    => 'Во время отправки сообщения возникла ошибка'
)
