            ...
            <div class="kotekst-box">
                ...
                <ul class="kotekst-box-items">
                    <li class="kotekst-box-item">
                        <div class="kotekst-item__img">
                            <svg  xmlns="http://www.w3.org/2000/svg" width="75px" height="85px"><g><path fill-rule="evenodd"  fill="rgb(255, 204, 0)" d="M37.000,3.000 L67.989,21.000 L67.989,57.000 L37.000,75.000 L6.010,57.000 L6.010,21.000 L37.000,3.000 Z"/></g>
                            </svg>
                        </div>
